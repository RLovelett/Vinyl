...
public struct TrackFactory {
    ...
    public static func createTrack(_ url: URL, statusCode: Int, body: Data? = nil, error: NSError? = nil, headers: HTTPHeaders = [:]) -> Track {
    ...
    public static func createBadTrack(_ url: URL, statusCode: Int, error: NSError? = nil, headers: HTTPHeaders = [:]) -> Track {
        
        return createTrack(url, statusCode: statusCode, body: nil, error: error, headers: headers)
    }

    public static func createErrorTrack(_ url: URL, error: NSError) -> Track {
