...
/// The `Track` type represents the parsed data from a Vinyl fixture. A `Track` consists of two
/// other types. Those types are the `Track.Request` and the `Track.Response`.
public struct Track {
